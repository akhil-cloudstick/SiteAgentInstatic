...
- `docs/architecture/PLAN.md` — the full project plan.
- `docs/architecture/PLAN_V1.md` — the first version to build (the slice that ships first).
- `docs/architecture/reviews/PLAN-REVIEW-LOG.md` — history of locked decisions + a prior interim (same-model) self-review with findings F1–F11.
