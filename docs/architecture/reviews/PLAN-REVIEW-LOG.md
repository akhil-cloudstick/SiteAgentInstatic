...
**Doc-fold applied (2026-06-29):** folded the above into `docs/architecture/PLAN.md` + `docs/architecture/PLAN_V1.md` (AI Gateway into v1 + key-never-exposed wording; 2FA flow; spike #4 + animation spike #A added; build-order gating updated). Created `docs/architecture/reviews/PLAN-REVIEW-INSTRUCTIONS.md` for the user's external AI review. **No code built.** Next: user runs external AI review → then spikes (#9 first) on explicit go.

## Round 3 — external AI review (`docs/architecture/reviews/plan_review_2.md`, VERDICT: REVISE, 2026-06-29)
