> ## ⚠️ STALE SNAPSHOT — do not edit, do not follow
>
> This is an old copy (438 lines) of the build rule that used to sit in `Operator/docs/`.
> The **live, enforced** rule is [`Operator/rules/templateRule.md`](../../Operator/rules/templateRule.md)
> (622 lines) — OpenDesign reads it at run time via `OD_CMS_RULE_FILE`, hot-reloaded.
> Editing this file does nothing. Kept only for history; see
> [`od-cms-compliance.md`](./od-cms-compliance.md) for how the rule is actually applied.
