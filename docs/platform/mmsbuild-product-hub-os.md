...
Already fully implemented and documented: [`od-cms-compliance.md`](../integration/od-cms-compliance.md).
...
[`od-cms-vision.md`](../integration/od-cms-vision.md) today states: *"OD is the source of truth; a re-share
...
- [`od-cms-vision.md`](../integration/od-cms-vision.md) — the Share-to-CMS acceptance bar (**and the overwrite
  invariant this poster changes**)
- [`od-cms-compliance.md`](../integration/od-cms-compliance.md) — the "CMS-Compatible Build" system, in full
- [`docs/architecture/Architecture.md`](../architecture/Architecture.md) — the real runtime topology today
- [`../mmsbuild-handoff/10-integration-summary.md`](../../mmsbuild-handoff/10-integration-summary.md) —
