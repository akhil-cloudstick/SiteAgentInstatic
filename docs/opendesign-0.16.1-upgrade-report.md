...
**Companion:** `docs/opendesign-upgrade-runbook.md` (the reusable procedure) ·
`docs/opendesign-version-comparison.md` (what each release changed).
...
`docs/opendesign-version-comparison.md` claimed we were on **0.12.x**. We were actually on
