 ...
 *
 *   POST /cms/api/cms/runtime/dependencies/resolve — resolve a
 ...
 *
 *   POST /cms/api/cms/runtime/preview — build a single-page preview
 ...
 *
 *   POST /cms/api/cms/runtime/validate — compile every enabled draft
...
export async function handleRuntimeRoutes(req: Request, db: DbClient): Promise<Response | null> {
  ...
  if (url.pathname === '/cms/api/cms/runtime/validate') {
