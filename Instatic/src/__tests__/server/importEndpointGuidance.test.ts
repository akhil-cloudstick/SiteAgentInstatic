 ...
 *
 *   POST /cms/api/cms/import          — JSON site bundle
 *   POST /cms/api/cms/import/archive  — the .zip the export UI downloads
 *
...
function importRequest(body: BodyInit): Request {
  return new Request('http://localhost/cms/api/cms/import?strategy=merge-add', {
    method: 'POST',
...
describe('POST /cms/api/cms/import with a ZIP body', () => {
