...
// instrumentation lives in AutomationsScreen; this suite is the acceptance gate for
...
describe('AutomationsScreen analytics', () => {
  beforeEach(() => {
  ...
  // `inMenu` marks the three actions the approved reference folds into the
  // row's `⋯` menu; Run and History stay inline on the row.
  it.each([
    { button: 'Run', element: 'run_now', inMenu: false },
    { button: 'History', element: 'history', inMenu: false },
    { button: 'Pause', element: 'pause', inMenu: true },
    { button: 'Edit', element: 'edit', inMenu: true },
    { button: 'Delete', element: 'delete', inMenu: true },
  ])('tracks the $element row action', async ({ button, element, inMenu }) => {
