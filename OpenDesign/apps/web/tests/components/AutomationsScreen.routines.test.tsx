...
import { sortRoutinesNewestFirst, AutomationsScreen } from '../../src/components/AutomationsScreen';
...
vi.mock('../../src/components/AutomationComposeModal', () => ({
...
describe('AutomationsScreen routine ordering and focus', () => {
  beforeEach(() => {
  ...
  it('focuses and expands a routine after create save', async () => {
    ...
    const focusedRow = await waitFor(() => {
      ...
      // CSS-Module class names are hashed, so the focus marker is a data
      // attribute the stylesheet keys off (`.row[data-focused='true']`).
