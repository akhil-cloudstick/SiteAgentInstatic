...
<html>
  ...
  // MMS: map web-root asset refs (/images/…) onto the project public/ folder so
  // the preview shows the same images the published site will.
  ...
  // MMS: catch JS-rendered <img src="/…"> at runtime too (see injectAssetRewriteBridge).
