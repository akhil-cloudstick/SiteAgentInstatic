...
export const HomeHero = forwardRef<HomeHeroHandle, Props>(function HomeHero(
  ...
  return (
    <section ref={homeHeroRef} className="home-hero" data-testid="home-hero">
      {/* MMS horizontal logo lockup in place of a text wordmark.
          The height is fixed in CSS and the width left auto, so the image can
          never render at its natural size. That is exactly what went wrong
          before: an `<img src="/app-icon.png">` sat inside a 26px SPAN with no
          rule targeting the `<img>` itself, so a 2048×2048 illustration painted
          over the whole page. Never add a bare <img> here without sizing it. */}
      <div className="home-hero__brand">
        <img
          className="home-hero__brand-logo"
          src="/mms-horizontal.png"
          alt="MMS Design"
          draggable={false}
        />
      </div>
