...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'MMS Design plugin',
  audience: 'MMS Design plugin authors',
  topic: 'packaging a reusable workflow as an MMS Design plugin',
};
...
export function HomeView({
  ...
  async function handlePickWorkingDir() {
    ...
    if (isOpenDesignHostAvailable()) {
      ...
      setError(
        `Couldn't open the folder picker (${'reason' in result ? result.reason : 'host unavailable'}). Please update MMS Design and try again.`,
      );
      return null;
    }
