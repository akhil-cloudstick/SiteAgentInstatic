...
function historyWithWorkspaceContext(
  ...
  const block = [
    ...
    'MMS Design selected or inferred these workspace contexts for this turn. Treat absolute paths as reference context unless the user explicitly asks to edit them.',
...
export function ProjectView({
  ...
  // "Share to MMS Design" — kicks off the bundled `od-share-to-community`
...
function pluginWorkflowPlannedSteps(action: PluginFolderAgentAction): string[] {
  ...
  return [
    'Ensure the MMS Design fork exists',
