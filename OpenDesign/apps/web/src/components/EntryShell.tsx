...
// top bar. Upstream re-adds it at v0.16.1; we keep it off the tenant surface.
...
function OnboardingView({
  ...
  // MMS Design Cloud sign-in in one gesture. Mirrors the old AMR card's
  ...
  // Connect step, default face: a minimal, centered MMS Design Cloud sign-in
    ...
    return (
      ...
      >
        ...
        <footer className="onboarding-cloud__footer">
          © {new Date().getFullYear()} MMS Design · {t('settings.onboardingCloudRights')}
        </footer>
      </section>
    );
  }
