...
export interface Dict {
  ...
  'pluginsScreen.add': string;
  'pluginsScreen.handoffAria': string;
  'pluginsScreen.handoffTitle': string;
  'pluginsScreen.handoffTitleUnscoped': string;
  'pluginsScreen.handoffSummary': string;
  'pluginsScreen.handoffOpen': string;
  'pluginsScreen.modeAria': string;
  'pluginsScreen.modePlugins': string;
  'pluginsScreen.modeSkills': string;
  'pluginsScreen.filtersAria': string;
  'pluginsScreen.scopeAria': string;
  'pluginsScreen.scopeOfficial': string;
  'pluginsScreen.scopePersonal': string;
  'pluginsScreen.searchPlugins': string;
  'pluginsScreen.searchSkills': string;
  'pluginsScreen.categoriesAria': string;
  'pluginsScreen.categoryAll': string;
  'pluginsScreen.loading': string;
  'pluginsScreen.tryIt': string;
  'pluginsScreen.install': string;
  'pluginsScreen.installing': string;
  'pluginsScreen.moreActions': string;
  'pluginsScreen.details': string;
  'pluginsScreen.provenanceAction': string;
  'pluginsScreen.setupNote': string;
  'pluginsScreen.badgeOfficial': string;
  'pluginsScreen.badgeTrusted': string;
  'pluginsScreen.badgeRestricted': string;
  'pluginsScreen.badgePersonal': string;
  'pluginsScreen.installed': string;
  'pluginsScreen.actionFailed': string;
  'pluginsScreen.importedLink': string;
  'pluginsScreen.importedUpload': string;
  'pluginsScreen.nounExpertSuite': string;
  'pluginsScreen.nounSkill': string;
  'pluginsScreen.nounExpertSuitesPlural': string;
  'pluginsScreen.nounSkillsPlural': string;
  'pluginsScreen.emptyFilteredTitle': string;
  'pluginsScreen.emptyFilteredBody': string;
  'pluginsScreen.emptyPersonalTitle': string;
  'pluginsScreen.emptyPersonalBody': string;
  'pluginsScreen.emptyOfficialTitle': string;
  'pluginsScreen.emptyOfficialBody': string;
  'pluginsScreen.addTitle': string;
  'pluginsScreen.addLede': string;
  'pluginsScreen.addClose': string;
  'pluginsScreen.addKindAria': string;
  'pluginsScreen.addPromptTitle': string;
  'pluginsScreen.addPromptBody': string;
  'pluginsScreen.addPromptAction': string;
  'pluginsScreen.addLinkTitle': string;
  'pluginsScreen.addLinkBody': string;
  'pluginsScreen.addLinkInputAria': string;
  'pluginsScreen.addLinkAction': string;
  'pluginsScreen.addSkillImportUnavailable': string;
  'pluginsScreen.addFolderTitle': string;
  'pluginsScreen.addFolderBody': string;
  'pluginsScreen.addFolderChoose': string;
  'pluginsScreen.addFolderAction': string;
  'pluginsScreen.addWorking': string;
  'pluginsScreen.provenanceLede': string;
  'pluginsScreen.provenance.id': string;
  'pluginsScreen.provenance.version': string;
  'pluginsScreen.provenance.trust': string;
  'pluginsScreen.provenance.sourceKind': string;
  'pluginsScreen.provenance.source': string;
  'pluginsScreen.provenance.ref': string;
  'pluginsScreen.provenance.catalog': string;
  'pluginsScreen.provenance.catalogEntry': string;
  'pluginsScreen.provenance.catalogUrl': string;
  'pluginsScreen.provenance.manifestDigest': string;
  'pluginsScreen.provenance.integrity': string;
  'pluginsScreen.provenance.capabilities': string;
  'pluginsScreen.provenance.capabilitiesNone': string;
  'pluginsScreen.provenance.license': string;
  'pluginsScreen.provenance.homepage': string;
  'pluginsScreen.provenance.installCommand': string;
  ...
  'automations.savedCount': string;
  'automations.running': string;
  'automations.rowMenuAria': string;
  'automations.promptFieldLabel': string;
  'automations.promptHint': string;
  'automations.runtimeNoteTitle': string;
  'automations.runtimeNoteBody': string;
  'automations.runtimeNoteBodyUnscoped': string;
  'automations.triggerManual': string;
  'automations.triggerScheduled': string;
  'automations.scheduleDay': string;
  'automations.scheduleDone': string;
  'automations.reviewPolicyAlways': string;
  'automations.reviewPolicyTrustedSource': string;
  'automations.reviewPolicyAutoApply': string;
  ...
  // Design systems screen + create dialog (MMSBUILD reference screen)
  'ds.pageKicker': string;
  'ds.pageSubtitle': string;
  'ds.emptyListTitle': string;
  'ds.emptyPreviewTitle': string;
  'ds.emptyPreviewBody': string;
  'ds.officialPresetSource': string;
  'ds.detailSourceUpdated': string;
  'ds.packageDesignMd': string;
  'ds.packageTokens': string;
  'ds.packageUiKit': string;
  'ds.packagePreviews': string;
  'ds.copyPalette': string;
  'ds.paletteCopied': string;
  'ds.typeDisplayMeta': string;
  'ds.typeBodyMeta': string;
  'ds.voiceEmpty': string;
  'ds.imageryEmpty': string;
  'ds.provenanceInherited': string;
  'ds.provenanceOwned': string;
  'ds.provenanceOwnedBody': string;
  'ds.inspectSourceContext': string;
  'dsCreate.dialogTitle': string;
  'dsCreate.dialogSubtitle': string;
  'dsCreate.sourceRequiredHint': string;
  'dsCreate.addFilesHint': string;
  'dsCreate.chooseFiles': string;
  'dsCreate.dropHint': string;
  'dsCreate.filesStagedOne': string;
  'dsCreate.filesStagedOther': string;
  'dsCreate.describeBrandPlaceholder': string;
  'dsCreate.advancedSources': string;
  'dsCreate.chooseFolder': string;
  'dsCreate.stepsAria': string;
  'dsCreate.step1Title': string;
  'dsCreate.step1Desc': string;
  'dsCreate.step2Title': string;
  'dsCreate.step2Desc': string;
  'dsCreate.step3Title': string;
  'dsCreate.step3Desc': string;
  'dsCreate.confirmKicker': string;
  'dsCreate.confirmTitle': string;
  'dsCreate.confirmBody': string;
  'dsCreate.confirmLinks': string;
  'dsCreate.confirmFiles': string;
  'dsCreate.confirmDesignMdAdded': string;
  'dsCreate.confirmNoDesignMd': string;
  'dsCreate.outputs': string;
  'dsCreate.extract': string;
  'dsCreate.figmaInvalid': string;
  ...
  'integrations.mcpEmptyBody': string;
  'integrations.mcpConfiguredTitle': string;
  'integrations.mcpConfiguredBody': string;
  'integrations.connectorsSubtitle': string;
  'integrations.connectorConfigured': string;
  'integrations.connectorSetupRequired': string;
  'integrations.adapterWarning': string;
  'integrations.adapterWarningBody': string;
  'integrations.everywhereSubtitle': string;
  'integrations.daemonRequired': string;
  'integrations.addServerTitle': string;
  'integrations.addServerSubtitle': string;
  'integrations.addServerClose': string;
  'integrations.addServerSource': string;
  'integrations.addServerTemplate': string;
  'integrations.addServerCustom': string;
  'integrations.addServerChooseTemplate': string;
  'integrations.addServerFilter': string;
  'integrations.addServerNoMatch': string;
  'integrations.addServerName': string;
  'integrations.addServerNamePlaceholder': string;
  'integrations.addServerTransport': string;
  'integrations.addServerCommand': string;
  'integrations.addServerUrl': string;
  'integrations.addServerCustomHint': string;
  'integrations.addServerFooterNote': string;
