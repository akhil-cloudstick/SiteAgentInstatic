...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to MMS Design — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to MMS Design & retry',
  'chat.amrError.authMessage': 'Your MMS Design account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your MMS Design balance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with MMS Design',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the MMS Design agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The MMS Design agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the MMS Design agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update MMS Design to the latest version, which ships a compatible runtime.",
  ...
  'app.brandPill': 'Beta',
  'app.brandSubtitle': 'Your shop\'s superpower',
  'app.welcomeLoading': 'Loading workspace…',
  'settings.welcomeKicker': '',
  'settings.welcomeTitle': 'Welcome to MMS Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. MMS Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. MMS Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingAmrModelSourceLabel': 'MMS Design',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to MMS Design to continue.',
  ...
  'settings.onboardingDesignIntroGenerateBody': 'Upload your design system from a website, Figma files, images, and other content assets.',
  ...
  'settings.onboardingGithubTitle': 'Import from a URL',
  'settings.onboardingGithubBody': 'Use any website or code URL.',
  ...
  'settings.onboardingUsePrototype': '📱 Website / app UI',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the MMS Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to MMS Design.',
  ...
  'settings.amrWalletRefreshTitle': 'Refresh MMS Design wallet balance',
  ...
  'settings.amrAccountStatus': 'MMS Design account status',
  ...
  'settings.mcpServerHint': 'Expose MMS Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the MMS Design team',
  'settings.privacyConsentKicker': 'Help us improve MMS Design',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how MMS Design performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time MMS Design starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but MMS Design could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your MMS Design projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure MMS Design is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in MMS Design, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'MMS Design must be running for MCP tool calls to succeed. If you started your coding agent before opening MMS Design, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the MMS Design Discord',
  'entry.discordAriaWithOnline': 'Join the MMS Design Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow MMS Design on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow MMS Design on Xiaohongshu',
  ...
  'homeHero.subtitlePrefix': 'Your shop\'s superpower — design anything, on brand.',
  ...
  'homeHero.chip.prototype': 'Website',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable MMS Design plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit MMS Design',
  ...
  'handoff.promptIntro': 'Continue from this local MMS Design project folder:',
  ...
  'pluginsHome.subtitle': 'Ready-to-use MMS Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with MMS Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to MMS Design',
  'pluginCard.contributeTitle': 'Contribute plugin to MMS Design with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use MMS Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure MMS Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use MMS Design everywhere',
  'useEverywhere.modalTitle': 'Use MMS Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop MMS Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'MMS Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'MMS Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires MMS Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without MMS Design at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive MMS Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose MMS Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'MMS Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover MMS Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the MMS Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without MMS Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). MMS Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside MMS Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + MMS Design extras)',
  ...
  'routines.fieldNamePlaceholder': 'Automation name',
  ...
  'entry.githubStarAria': 'Star MMS Design on GitHub',
  ...
  'newproj.titlePrototype': 'New website',
  ...
  'newproj.locationDefault': 'MMS Design projects',
  ...
  'designs.menuOpen': 'Open',
  'designs.tagBrand': 'Brand',
  'designSystemPicker.label': 'Design system',
  'entry.accountMenuAria': 'Account and settings',
  'entry.accountMenuNamedAria': 'Account: {name}',
  'startDesk.recentsEmpty': 'No projects yet.',
  'startDesk.recentsEmptyAction': 'Write your first brief',
  'startDesk.typeDesignSystem': 'Design system',
  'startDesk.workingDirLabel': 'Working directory:',
  'startDesk.workingDirNone': 'Not selected',
  'startDesk.workingDirNeeded': 'Needed for file edits',
  ...
  'examples.modePrototypeDesktop': 'Websites · Desktop',
  'examples.modePrototypeMobile': 'Websites · Mobile',
  ...
  'examples.tagMobilePrototype': 'Mobile website',
  'examples.tagDesktopPrototype': 'Desktop website',
  ...
  'socialShare.openDesignSection': 'Share MMS Design',
  'socialShare.openDesignTitle': 'MMS Design on GitHub',
  'socialShare.openDesignText': 'MMS Design is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with MMS Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with MMS Design: {title}\n{url}\nMMS Design repo: {repo}',
  ...
  'brandEnrichment.body': "MMS Design will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask MMS Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want MMS Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure MMS Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying MMS Design? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to MMS Design on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow MMS Design on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow MMS Design on Xiaohongshu for tips and inspiration.',
  ...
  'assistant.shareToOpenDesign': 'Share to MMS Design',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with MMS Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with MMS Design — no download needed.',
  ...
  'settings.designSystemsImportGithub': 'Import from a URL',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple MMS Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions MMS Design should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'MMS Design {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'MMS Design is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'MMS Design could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. MMS Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit MMS Design',
  'updater.quitFailedBody': 'The installer is open, but MMS Design could not quit. Quit MMS Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. MMS Design will close and open the installer.',
  'updater.readyVersion': 'MMS Design {version} is ready. MMS Design will close and open the installer.',
  ...
  'automations.savedCount': '{n} saved',
  'automations.running': 'Running',
  'automations.rowMenuAria': 'More actions for {name}',
  'automations.promptFieldLabel': 'What should the agent do?',
  'automations.promptHint': 'Type @ to reference available Skills, Plugins, MCP or Connectors.',
  'automations.runtimeNoteTitle': 'Scheduled runs require an available agent',
  'automations.runtimeNoteBody': 'MMS Design executes timers while its local daemon is running. Each run compiles the current {client} → {project} references and only the resources available at that time.',
  'automations.runtimeNoteBodyUnscoped': 'MMS Design executes timers while its local daemon is running. Each run compiles the references available to this session at that time.',
  'automations.triggerManual': 'Manual',
  'automations.triggerScheduled': 'Scheduled',
  'automations.scheduleDay': 'Day',
  'automations.scheduleDone': 'Done',
  'automations.reviewPolicyAlways': 'Human review',
  'automations.reviewPolicyTrustedSource': 'Trusted source',
  'automations.reviewPolicyAutoApply': 'Auto-apply',
  ...
  'automations.templatesEmptyTitle': 'No templates in this filter',
  'automations.templatesEmptyBody': 'Installed skills and the daemon catalogue can add more templates here.',
  ...
  'automations.promptPlaceholder': 'Describe the recurring work. Type @ to add skills, installed plugins, enabled MCP servers or connected connectors.',
  ...
  'dsManager.createBody': 'Teach MMS Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions MMS Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach MMS Design your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'MMS Design turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'dsCreate.sourceSectionTitle': 'Extract from a website or source material',
  ...
  'dsCreate.githubWebsiteLabel': 'Website URL',
  'dsCreate.add': 'Add',
  ...
  'projects.kindPrototype': 'WEBSITE',
  ...
  'entry.mailAria': 'Email MMS Design',
  ...
  "entry.cloudCalloutBody": "Sign in to use MMS Design and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss MMS Design note",
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to MMS Design, or use a deploy option to share this file.',
  ...
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. MMS Design will close and open the installer.',
  'updater.reinstallReadyVersion': 'MMS Design {version} requires a full reinstall. MMS Design will close and open the installer.',
  'whatsNew.updatedTitle': 'MMS Design {version} is here',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in MMS Design. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside MMS Design — not via MCP, CLI, API, or other surfaces. Final interpretation rests with MMS Design. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve MMS Design",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend MMS Design to a colleague or friend?",
