...
export const en: Dict = {
  ...
  'pluginsScreen.handoffSummary': 'Wrapper context only. OpenDesign resources do not become the authoritative source archive.',
  ...
  'pluginsScreen.scopeOfficial': 'OpenDesign official',
  ...
  'pluginsScreen.setupNote': 'Catalog entries are repository-backed. Install, trust and granted capabilities are resolved by the local OpenDesign daemon.',
  'pluginsScreen.badgeOfficial': 'OpenDesign official',
  ...
  'pluginsScreen.actionFailed': 'That action could not be completed. Check that the local OpenDesign daemon is reachable and try again.',
  ...
  'pluginsScreen.emptyPersonalBody': 'Install from OpenDesign official, or use Add to create one.',
  'pluginsScreen.emptyOfficialTitle': 'No official {noun} yet',
  'pluginsScreen.emptyOfficialBody': 'The local OpenDesign daemon has not returned an official catalog for this shelf yet.',
  'pluginsScreen.addTitle': 'Add {noun}',
  'pluginsScreen.addLede': 'Create with the agent or import a resource that already follows the OpenDesign plugin format.',
  ...
  'pluginsScreen.addLinkBody': 'OpenDesign fetches the manifest and validates the capabilities before installation.',
  ...
  'pluginsScreen.addFolderBody': 'Choose a folder containing an OpenDesign manifest, or a packed .zip. Validation runs before anything is installed.',
