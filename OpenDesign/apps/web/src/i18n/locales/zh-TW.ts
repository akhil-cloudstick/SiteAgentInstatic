...
export const zhTW: Dict = {
  ...
  "chat.amrCard.switchCta": "切換到 MMS Design Cloud 並重試",
  ...
  "chat.amrError.rechargeCta": "為 MMS Design Cloud 儲值",
  "chat.amrBalanceGate.title": "升級方案，繼續創作",
  "chat.amrBalanceGate.message": "餘額不足（目前 {balance}），升級方案或儲值後，任務馬上就能開始。",
  "chat.amrBalanceGate.benefitsTitle": "MMS Design Cloud 為你提供",
  ...
  "chat.amrBalanceGate.signedOutTitle": "登入 MMS Design Cloud，開始創作",
  "chat.amrBalanceGate.signedOutMessage": "目前使用的是 MMS Design Cloud 智能體，登入後這個任務馬上就能開始。",
  ...
  "chat.runError.cpuUnsupportedMessage": "此智能體的執行時需要此裝置處理器不支援的指令集（AVX2），因此無法啟動。請將 MMS Design 更新到最新版本，新版本附帶相容的執行時。",
  "common.cancel": "取消",
  ...
  "settings.welcomeTitle": "歡迎使用 MMS Design",
  ...
  "settings.onboardingCloudTitle": "登入 MMS Design",
  "settings.onboardingCloudBody":
    "登入後可直接用雲端 AI 開始設計，無需任何複雜設定。",
  "settings.onboardingCloudSignIn": "登入 MMS Design 雲端",
  ...
  "settings.amrWalletRefreshTitle": "重新整理 MMS Design Cloud 錢包餘額",
  ...
  "settings.amrAccountStatus": "MMS Design Cloud 帳戶狀態",
  "settings.amrConsole": "管理",
  "settings.amrLoginErrorCompact": "MMS Design Cloud 登入失敗。",
  ...
  "settings.privacy": "隱私",
  "settings.privacyHint": "與 MMS Design 團隊共享哪些資料",
  "settings.privacyConsentKicker": "協助我們改進 MMS Design",
  ...
  "entry.discordAria": "加入 MMS Design Discord",
  "entry.discordAriaWithOnline": "加入 MMS Design Discord - {online}",
  ...
  "entry.followLinkedinLabel": "在 LinkedIn 上追蹤 MMS Design",
  "entry.followXiaohongshuLabel": "在小紅書上追蹤 MMS Design",
  ...
  "messageCenter.subtitle": "MMS Design 更新、平台公告和權益提醒",
  ...
  "handoff.amrWebsite": "開啟 MMS Design Cloud 官網",
  ...
  "handoff.promptIntro": "請基於這個 MMS Design 專案的本機資料夾繼續實作：",
  ...
  "pluginsScreen.handoffTitle": "Product Hub handoff Â· {client} / {project}",
  "pluginsScreen.handoffTitleUnscoped": "Product Hub handoff Â· no project scoped",
  ...
  "pluginsScreen.loading": "Loading catalogâ€¦",
  "pluginsScreen.tryIt": "Try it",
  "pluginsScreen.install": "Install",
  "pluginsScreen.installing": "Checkingâ€¦",
  ...
  "pluginsScreen.addSkillImportUnavailable": "Skills are imported and edited in Integrations â†’ Skills. There is no link or archive install path for them.",
  ...
  "pluginsScreen.addWorking": "Workingâ€¦",
  ...
  "pluginCard.contributeAria": "將 {title} 貢獻至 MMS Design",
  "pluginCard.contributeTitle": "透過 pull request 將外掛貢獻至 MMS Design",
  ...
  "useEverywhere.modalAria": "隨處使用 MMS Design",
  "useEverywhere.modalTitle": "隨處使用 MMS Design",
  ...
  "useEverywhere.section.cli.heading": "從任何 shell 操作 MMS Design",
  ...
  "routines.fieldNamePlaceholder": "自動化名稱",
  ...
  "entry.githubStarAria": "在 GitHub 為 MMS Design 點亮 Star",
  ...
  "newproj.locationDefault": "MMS Design 專案",
  ...
  "designs.menuOpen": "開啟",
  "designs.tagBrand": "品牌",
  "designSystemPicker.label": "設計系統",
  "entry.accountMenuAria": "帳戶與設定",
  "entry.accountMenuNamedAria": "帳戶：{name}",
  "startDesk.recentsEmpty": "尚未有專案。",
  "startDesk.recentsEmptyAction": "寫下第一份需求",
  "startDesk.typeDesignSystem": "設計系統",
  "startDesk.workingDirLabel": "工作目錄：",
  "startDesk.workingDirNone": "未選擇",
  "startDesk.workingDirNeeded": "編輯檔案時需要",
  ...
  "avatar.amrConsole": "MMS Design Cloud 帳戶",
  ...
  "socialShare.openDesignSection": "分享 MMS Design",
  "socialShare.openDesignTitle": "GitHub 上的 MMS Design",
  ...
  "chat.activeFilePlaceholder": "讓 MMS Design 修改 {file}...",
  ...
  "designBrowser.reference.kicker": "MMS Design 浏览器",
  ...
  "preview.shareTextDefault": "MMS Design 模板：{title}",
  ...
  "assistant.shareToOpenDesign": "分享到 MMS Design",
  ...
  "pet.navHint": "領養與自訂",
  "pet.tabBuiltIn": "內建",
  "pet.tabBuiltInHint": "MMS Design 內建的精選寵物 — 一鍵領養。",
  "pet.builtInEmpty":
  ...
  "pet.codexBundled": "內建",
  "pet.codexBundledTitle": "MMS Design 內建寵物，無需下載。",
  ...
  "updater.activeRunsTitle": "MMS Design 仍在執行任務",
  "updater.activeRunsBody": "仍有 {count} 個任務正在執行。現在重新啟動會中斷這些任務。",
  "updater.activeRunsUnknownBody": "MMS Design 無法確認是否仍有任務執行。現在重新啟動可能會中斷進行中的工作。",
  ...
  'settings.updateQuitFailed': '安裝程式已開啟，但 MMS Design 未能自動結束。',
  ...
  "automations.savedCount": "已儲存 {n} 個",
  "automations.running": "執行中",
  "automations.rowMenuAria": "{name} 的更多操作",
  "automations.promptFieldLabel": "希望代理做什麼？",
  "automations.promptHint": "輸入 @ 可參照可用的技能、外掛、MCP 或連接器。",
  "automations.runtimeNoteTitle": "排程執行需要可用的代理",
  "automations.runtimeNoteBody": "MMS Design 會在本機常駐程式執行時執行排程。每次執行都會彙整目前的 {client} → {project} 參照，且僅使用當下可用的資源。",
  "automations.runtimeNoteBodyUnscoped": "MMS Design 會在本機常駐程式執行時執行排程。每次執行都會彙整當下本工作階段可用的參照。",
  "automations.triggerManual": "手動",
  "automations.triggerScheduled": "排程",
  "automations.scheduleDay": "星期",
  "automations.scheduleDone": "完成",
  "automations.reviewPolicyAlways": "人工審查",
  "automations.reviewPolicyTrustedSource": "可信來源",
  "automations.reviewPolicyAutoApply": "自動套用",
  ...
  "automations.templatesEmptyTitle": "此篩選條件下沒有範本",
  "automations.templatesEmptyBody": "已安裝的技能與常駐程式目錄可在此加入更多範本。",
  "automations.useTemplate": "使用範本",
  "automations.promptPlaceholder": "描述需要重複執行的工作。輸入 @ 可加入技能、已安裝外掛、已啟用的 MCP 伺服器或已連接的連接器。",
  ...
  "ds.extractionRunningBody": "MMS Design 正在就地更新此體系。",
  ...
  'invite.landing.subtitle': "你受邀加入 MMS Design 一起協作。",
  ...
  'invite.success.body': "正在開啟 MMS Design，開始協作。",
  'invite.success.roleReceipt': "加入身分",
  'invite.success.enter': "進入工作空間",
  'invite.open.cta': "開啟 MMS Design",
  'invite.open.opening': "正在開啟 MMS Design…",
  'invite.open.retry': "已安裝？再次嘗試開啟",
  'invite.notInstalled.title': "沒有自動開啟？",
  'invite.notInstalled.body': "你的裝置可能尚未安裝 MMS Design。安裝後重新開啟此連結即可完成加入。",
  'invite.notInstalled.download': "下載 MMS Design",
  ...
  "settings.cloudCalloutTitle": "使用 MMS Design",
  ...
  "settings.dshSetupDescription": "MMS Design 將透過這台電腦上的 dsh CLI 安裝連接元件。",
  "settings.dshSetupNote": "只安裝 MMS Design 的 profile 元件。DeepSeek Harness 仍由你自行安裝和管理。",
  ...
  "fileViewer.shareMenuPublishViaOd": "快速分享（MMS Design 託管）",
  ...
  "fileViewer.publishFileRequiresWorkspace": "產生分享連結需要登入工作區。請登入 MMS Design，或改用「部署」分享此檔案。",
  ...
  "updater.reinstallReadyGeneric": "此更新需要完整重新安裝。MMS Design 將關閉並開啟安裝程式。",
  "updater.reinstallReadyVersion": "MMS Design {version} 需要完整重新安裝。MMS Design 將關閉並開啟安裝程式。",
  "whatsNew.updatedTitle": "MMS Design {version} 已更新",
  ...
  'library.getClipper': '取得 MMS Design 網頁剪藏擴充功能',
  ...
  'library.emptyHintBefore': '用 MMS Design 網頁剪藏擴充功能從任意網頁收藏，執行',
  ...
  'mcp.checking': '檢查中…',
  'mcp.clickConnectHint': '點擊「連線」，透過服務商的 OAuth 流程授予 MMS Design 存取權限。',
  ...
  'mcp.noManagedOAuthSaveDirect': '儲存此伺服器後，MMS Design 會直接使用它。',
  'mcp.noManagedOAuthUseAsConfigured': 'MMS Design 會依你的設定使用此伺服器。如果伺服器需要 token，請在下方新增標頭。',
  ...
  'mcp.starting': '啟動中…',
  'mcp.toGrantOAuthAccess': '透過服務商的 OAuth 流程授予 MMS Design 存取權限。',
  ...
  'memory.extractionSourceConnector': '已讀取已連接的應用程式，但 MMS Design 無法將這些上下文轉化為記憶。',
  'memory.extractionSourceChat': 'MMS Design 無法為這次對話執行記憶擷取。',
  ...
  'memory.noSuggestionsFound': '未找到記憶建議。MMS Design 暫時無法從所選應用程式中讀取到有用的內容。',
  ...
  'memory.chooseSourcesHint': '請先選擇已連接的應用程式。MMS Design 只會掃描你選取的應用程式。',
  ...
  'dsCreate.githubMethodOdAccount': 'MMS Design 帳號',
  'dsCreate.githubMethodOdAccountDesc': '由 MMS Design 管理的原生 GitHub 登入；此版本尚未使用 OD 託管的 GitHub 權杖。',
  ...
  'dsFlow.activityRunningTitle': 'MMS Design 正在更新此設計系統',
  ...
  'dsFlow.jobRebuildingTokens': 'MMS Design 正在重建 token',
  'dsFlow.jobRevising': 'MMS Design 正在修訂',
  'dsFlow.jobStillWorking': 'MMS Design 仍在處理中',
  ...
  'dsFlow.pickLocalAgentFirst': '請先選擇一個本機代理，然後讓 MMS Design 更新這個設計系統。',
  'dsFlow.previewPages': '預覽頁面',
  'dsFlow.proposedChanges': '建議的變更',
  'dsFlow.publishCardReady': 'MMS Design 已可供審閱。請對目前的成果給出回饋，確認它對後續專案有用後再發布。',
  'dsFlow.publishCardRevision': 'MMS Design 正在套用你的回饋。在準備更新草稿期間，你可以繼續審閱。',
  'dsFlow.publishCardTokenRebuild': 'MMS Design 正在準備一份供審閱的 token 契約重建。在你接受之前，目前生效的契約保持不變。',
  'dsFlow.publishCardWorking': 'MMS Design 仍在處理中，但你已經可以對目前的成果給出回饋。',
  ...
  'pluginDetail.officialBadge': 'MMS Design 官方',
  ...
  'campaign.deepseekV4Flash.boundary': '方案內的無限制模型額度與免費生成次數，僅可透過 MMS Design 使用；無法在 MCP/CLI/API 及其他場景使用。解釋權歸官方所有。部分模型尖峰時段需要排隊。',
  ...
  'experienceSurvey.tag': "期待您的回饋，與我們一起完善 MMS Design",
  'experienceSurvey.close': "關閉",
  'experienceSurvey.recommendation': "你有多大可能把 MMS Design 推薦給同事或朋友？",
